...
public class Chopper : MonoBehaviour
{
    ...
    class Wound
    {
        ...
        public Wound(GameObject g)//wound должна быть представлена как GameObject с мэшом и такими осями, чтобы вектор up перпендикулярен плоскости, которую отражает мэш
        {
            wound = g;
